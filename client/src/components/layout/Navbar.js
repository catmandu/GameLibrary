        ...
        <ul>
          <li className='dropdown'>
            ...
            <div className='dropdown-content'>
              ...
              <Link to='/game' onClick={() => SetCurrentGame(null)}>
                Add New Game
              </Link>
            </div>
          </li>
          <li className='dropdown'>
            ...
            <div className='dropdown-content'>
              ...
              <Link to='/developer' onClick={() => SetCurrentDeveloper(null)}>
                Add New Developer
              </Link>
            </div>
          </li>
          <li className='dropdown'>
            ...
            <div className='dropdown-content'>
              ...
              <Link to='/publisher' onClick={() => SetCurrentPublisher(null)}>
                Add New Publisher
              </Link>
            </div>
          </li>
          <li className='dropdown'>
            ...
            <div className='dropdown-content'>
              ...
              <Link to='/genre' onClick={() => SetCurrentGenre(null)}>
                Add New Genre
              </Link>
            </div>
          </li>
          <li className='dropdown'>
            ...
            <div className='dropdown-content'>
              ...
              <Link to='/platform' onClick={() => SetCurrentPlatform(null)}>
                Add New Platform
              </Link>
            </div>
          </li>
          <li className='dropdown'>
            ...
            <div className='dropdown-content'>
              <Link to='/user'>Edit User Info</Link>
              <Link to='/user' onClick={() => LogoutUser()}>
                Logout
              </Link>
            </div>
          </li>
